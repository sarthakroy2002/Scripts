...
# Sync Trees
git clone https://github.com/mishrabiswajit/device_realme_r5x -b 13-wip device/realme/r5x
git clone https://github.com/mishrabiswajit/vendor_realme_r5x vendor/realme/r5x
git clone https://github.com/mishrabiswajit/kernel_realme_r5x kernel/realme/r5x
